...
namespace Items
{
    internal class HandGun : IItemComponent, IItemControl
    {
        ...
        {
            if (input.SingleShoot && !advancedItem.IsReloading && !advancedItem.IsShooting && !advancedItem.IsUnloading) // Bal klikk
            {
                yield return Shoot();
            }
